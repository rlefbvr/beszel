...
// ICMP echo probe of the hub, the same as the network monitors of the agent
// (agent/network_monitor_ping.go): raw socket, unprivileged datagram socket, or
// the system ping command, detected once per address family.
